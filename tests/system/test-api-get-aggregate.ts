...
test('GET /aggregate with geoaggregations', async (t) => {
  ...
  {
    buckets: [{ data_type: 'string', frequency: 2, key: 'j' }],
    data_type: 'frequency_distribution',
    name: 'grid_geohash_frequency',
    overflow: 0,
  },
  {
    buckets: [{ data_type: 'string', frequency: 2, key: '80cdfffffffffff' }],
    data_type: 'frequency_distribution',
    name: 'grid_geohex_frequency',
    overflow: 0,
  },
  {
    buckets: [{ data_type: 'string', frequency: 2, key: '0/0/0' }],
    data_type: 'frequency_distribution',
  ...
  {
    buckets: [
      { data_type: 'string', frequency: 2, key: 'j' },
      { data_type: 'string', frequency: 2, key: 'f' },
    ],
    data_type: 'frequency_distribution',
  ...
  {
    buckets: [{ data_type: 'string', frequency: 4, key: '0/0/0' }],
    data_type: 'frequency_distribution',
...
test(
  ...
  async (t) => {
    ...
    {
      buckets: [
        { data_type: 'string', frequency: 1, key: 'jxw7rxty' },
        { data_type: 'string', frequency: 1, key: 'jxr4dd07' },
      ],
      data_type: 'frequency_distribution',
      name: 'grid_geohash_frequency',
      overflow: 0,
    ...
    {
      buckets: [
        { data_type: 'string', frequency: 1, key: '8acd5d4d8a0ffff' },
        { data_type: 'string', frequency: 1, key: '8acd5b701887fff' },
      ],
      data_type: 'frequency_distribution',
      name: 'grid_geohex_frequency',
      overflow: 0,
    ...
    {
      buckets: [
        { data_type: 'string', frequency: 1, key: '20/749889/687442' },
        { data_type: 'string', frequency: 1, key: '20/747479/680615' },
      ],
      data_type: 'frequency_distribution',
      name: 'grid_geotile_frequency',
      overflow: 0,
