...
const intersectsGeometry = fs.readFileSync(
  path.resolve(__dirname, '../fixtures/stac/intersectsGeometry.json'), 'utf8'
)
const noIntersectsGeometry = fs.readFileSync(
  path.resolve(__dirname, '../fixtures/stac/noIntersectsGeometry.json'), 'utf8'
)

const fixture = (filepath: string) => fs.readFileSync(path.resolve(__dirname, filepath), 'utf8')
...
test('/search flattened collection properties', async (t: ExecutionContext<TestContext>) => {
  ...
  response = await t.context.api.client.post('search', {
    json: {
      ...
      fields: { include: ['properties.platform'] }
    }
  })
...
test('/search fields filter', async (t: ExecutionContext<TestContext>) => {
  ...
  response = await t.context.api.client.post('search', {
    json: { fields: { exclude: ['collection'] } }
  })
  t.falsy(response.features[0].collection)

  response = await t.context.api.client.post('search', {
    json: { fields: { exclude: ['geometry'] } }
  })
  ...
  response = await t.context.api.client.post('search', {
    json: {
      fields: { include: ['collection', 'properties.proj:epsg'] }
    }
  })
  t.truthy(response.features[0].collection)
...
test('/search created and updated', async (t: ExecutionContext<TestContext>) => {
  const response = await t.context.api.client.post('search', {
    json: {
      query: { platform: { eq: 'landsat-8' } },
      fields: { include: ['properties.created', 'properties.updated'] }
    }
  })
...
test('/search collections', async (t: ExecutionContext<TestContext>) => {
  ...
  query = { collections: ['landsat-8-l1'] }
  ...
  query = { collections: ['collection2', 'landsat-8-l1'] }
...
test('/search preserve bbox in prev and next links', async (t: ExecutionContext<TestContext>) => {
  ...
  const datetime = '2015-02-19T00:00:00Z/2021-02-19T00:00:00Z'
  response = await t.context.api.client.post('search', {
    json: { bbox, datetime: datetime, limit: 1 }
  })
...
test('/search - query extension', async (t: ExecutionContext<TestContext>) => {
  ...
  response = await t.context.api.client.post('search', {
    json: { query: { platform: { eq: 'landsat-8' } } }
  })
  t.is(response.features.length, 2)

  response = await t.context.api.client.post('search', {
    json: { query: { platform: { neq: 'landsat-8' } } }
  })
  t.is(response.features.length, 1)

  response = await t.context.api.client.post('search', {
    json: { query: { platform: { startsWith: 'land' } } }
  })
  t.is(response.features.length, 2)

  response = await t.context.api.client.post('search', {
    json: { query: { platform: { endsWith: '-8' } } }
  })
  t.is(response.features.length, 2)

  response = await t.context.api.client.post('search', {
    json: { query: { platform: { contains: 'ndsa' } } }
  })
  t.is(response.features.length, 2)
  ...
  response = await t.context.api.client.post('search', {
    json: {
      query: {
        platform: { contains: 'ndsa', endsWith: '-8', startsWith: 'land' }
      }
    }
  })
  t.is(response.features.length, 2)
  ...
  response = await t.context.api.client.post('search', {
    json: {
      query: { platform: { contains: 'ndsa', neq: 'landsat-8' } }
    }
  })
  t.is(response.features.length, 0)
})
...
test('/search - filter extension - comparison operators', async (t: ExecutionContext<TestContext>) => {
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: { op: 'isNull', args: [{ property: 'landsat:product_id' }] }
    }
  })
  t.is(response.features.length, 3)
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: { op: 'isNull', args: [{ property: 'gsd' }] }
    }
  })
  t.is(response.features.length, 2)
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: { op: '<', args: [{ property: 'eo:cloud_cover' }, 8.0] }
    }
  })
  t.is(response.features.length, 2)
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: {
        op: 'and',
        args: [
          { op: '>', args: [{ property: 'eo:cloud_cover' }, 0.54] },
          { op: '<', args: [{ property: 'eo:cloud_cover' }, 8.0] }
        ]
      }
    }
  })
    ...
    json: {
      ...
      filter: {
        ...
        args: [
          ...
          { op: '<', args: [{ property: 'eo:cloud_cover' }, 0.5] }
        ]
      }
    }
  })
...
test('/search - filter extension - NOT logical operator', async (t: ExecutionContext<TestContext>) => {
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: {
        op: 'not',
        args: [{ op: '>', args: [{ property: 'eo:cloud_cover' }, 0.54] }]
      }
    }
  })
  t.is(response.features.length, 2)
...
test('/search - filter extension - handles timestamps', async (t: ExecutionContext<TestContext>) => {
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: {
        op: '>',
        args: [{ property: 'datetime' }, { timestamp: '2015-02-20T00:00:00Z' }]
      }
    }
  })
  t.is(response.features.length, 1)
  ...
  response = await t.context.api.client.post('search', {
    json: {
      filter: {
        op: '>',
        args: [{ property: 'datetime' }, '2015-02-20T00:00:00Z']
      }
    }
  })
  t.is(response.features.length, 1)
...
test('/search - filter, query, and item search in single request', async (t: ExecutionContext<TestContext>) => {
  const response = await t.context.api.client.post('search', {
    json: {
      collections: ['landsat-8-l1'],
      query: { 'view:sun_elevation': { gt: 20 } },
      filter: { op: '>', args: [{ property: 'eo:cloud_cover' }, 0.54] }
    }
  })
  t.is(response.features.length, 1)
  ...
  const response = await t.context.api.client.post('search', {
    json: {
      filter: {
        ...
        args: [
          { op: '=', args: [{ property: 'eo:cloud_cover' }, 0.54] },
          { op: '=', args: [{ property: 'collection' }, 'collection2'] }
        ]
      }
    }
  })
  ...
  const response = await t.context.api.client.post('search', {
    json: {
      filter: {
        ...
        args: [
          { property: 'datetime' },
          ['2015-02-19T15:06:12.565047+00:00', '2019-02-19T15:06:12.565047Z']
        ]
      }
    }
  })
...
test('POST /search with collection restriction returns filtered collections', async (t: ExecutionContext<TestContext>) => {
  ...
  {
    const r = await t.context.api.client.post(urlpath,
      { resolveBodyOnly: false, json: { _collections: [] } })
  ...
  {
    const r = await t.context.api.client.post(urlpath,
      { resolveBodyOnly: false, json: { _collections: [collectionId] } })
  ...
  {
    const r = await t.context.api.client.post(urlpath,
      { resolveBodyOnly: false, json: { _collections: [collectionId, 'foo', 'bar'] } })
  ...
  {
    const r = await t.context.api.client.post(urlpath,
      { resolveBodyOnly: false, json: { _collections: ['not-a-collection'] } })
...
test('POST /search with filter restriction returns filtered results', async (t: ExecutionContext<TestContext>) => {
  ...
  {
    const r = await t.context.api.client.post(urlpath,
      { resolveBodyOnly: false, json: { _filter: null } })
    ...
    const r = await t.context.api.client.post(urlpath,
      {
        resolveBodyOnly: false,
        json: {
          _filter: { op: '=', args: [{ property: 'id' }, 'foobar'] }
        }
      })
    ...
    const r = await t.context.api.client.post(urlpath,
      {
        ...
        json: {
          _filter: {
            op: '=',
            args: [{ property: 'landsat:scene_id' }, 'LC80100102015050LGN00']
          }
        }
      })
    ...
    const r = await t.context.api.client.post(urlpath,
      {
        resolveBodyOnly: false,
        json: {
          _filter: { op: '=', args: [{ property: 'landsat:scene_id' }, 'foo'] }
        }
      })
    ...
    const r = await t.context.api.client.post(urlpath,
      {
        resolveBodyOnly: false,
        json: {
          _filter: { op: '=', args: [{ property: 'id' }, 'LC80100102015050LGN00'] },
          filter: { op: '=', args: [{ property: 'id' }, 'LC80100102015082LGN00'] }
        }
      })
