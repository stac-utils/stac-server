...
- **Guides > [Configuration](../configuration/index.md)** - Configure collections and environment variables
- **Reference > [API Overview](api.md)** - Complete endpoint specifications
- **About > [Contributing](../development/contributing.md)** - Contribute to the project
